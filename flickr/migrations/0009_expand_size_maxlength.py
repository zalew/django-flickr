...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('flickr_photodownload', 'size', models.CharField(max_length=11))

        db.alter_column('flickr_photosizedata', 'size', models.CharField(max_length=11))

    def backwards(self, orm):

        db.alter_column('flickr_photodownload', 'size', models.CharField(max_length=10))

        db.alter_column('flickr_photosizedata', 'size', models.CharField(max_length=10))
