...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PhotoDownload.ori'
        db.delete_column('flickr_photodownload', 'ori')

        # Adding field 'PhotoDownload.size'
        db.add_column('flickr_photodownload', 'size',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PhotoDownload.ori'
        db.add_column('flickr_photodownload', 'ori',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PhotoDownload.size'
        db.delete_column('flickr_photodownload', 'size')
