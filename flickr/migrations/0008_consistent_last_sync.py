...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Collection.last_sync'
        db.alter_column('flickr_collection', 'last_sync', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Photo.last_sync'
        db.alter_column('flickr_photo', 'last_sync', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'PhotoSet.last_sync'
        db.alter_column('flickr_photoset', 'last_sync', self.gf('django.db.models.fields.DateTimeField')(null=True))
    def backwards(self, orm):

        # Changing field 'Collection.last_sync'
        db.alter_column('flickr_collection', 'last_sync', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=now()))

        # Changing field 'Photo.last_sync'
        db.alter_column('flickr_photo', 'last_sync', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=now()))

        # Changing field 'PhotoSet.last_sync'
        db.alter_column('flickr_photoset', 'last_sync', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=now()))
    models = {
        'auth.group': {
