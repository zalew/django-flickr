...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.originalformat'
        db.add_column('flickr_photo', 'originalformat',
    ...
    def backwards(self, orm):
        # Deleting field 'Photo.originalformat'
        db.delete_column('flickr_photo', 'originalformat')
    ...
    models = {
        ...
        'flickr.photo': {
            ...
            'originalsecret': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
